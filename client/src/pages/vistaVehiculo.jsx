    ...
    <div className='bloques-cerrado'>
      <Container>
        ...
        <Carousel /* className="d-block w-100" */ interval={6000} >
          <Carousel.Item>
            <img
              style={{ /* minWidth:'100vw', */ maxWidth:'100vw', minHeight:'34vh', maxHeight:'34vw'  }}
          ...
          <Carousel.Item>
            <img style={{ /* minWidth:'100vw', */ maxWidth:'100vw', minHeight:'34vh', maxHeight:'34vw'  }}
            /* className="d-block w-100" */
          ...
          <Carousel.Item>
            <img style={{ /* minWidth:'100vw', */ maxWidth:'100vw', minHeight:'34vh', maxHeight:'34vw'  }}/* className="d-block w-100" */  
